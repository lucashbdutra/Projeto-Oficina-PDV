...
import com.pdv.oficina.model.service.GenericCrudService;
...
public abstract class GenericCrudRest<T extends GenericEntity<I>, I, S extends GenericCrudService<T, I, ?>> {
    ...
    public @ResponseBody ResponseEntity<T> alterar(@ApiParam(value = "Objeto entida a ser atualizada.", required = true) @Valid final @RequestBody T entity,
                                                   final @PathVariable I id) throws Exception {
    ...
    public @ResponseBody ResponseEntity<T> buscar(final @PathVariable I id) throws Exception {
    ...
    public @ResponseBody ResponseEntity<List<T>> listar() throws Exception {
    ...
    public ResponseEntity<Void> remover(final @PathVariable I id) throws Exception {
